...
class Ui_FrmAluguel(object):
    ...
    def setupUi(self, FrmAluguel):
        ...
        self.groupBox = QGroupBox(FrmAluguel)
        ...
        self.EdtkmEntrada = QLineEdit(self.groupBox)
        self.EdtkmEntrada.setGeometry(QtCore.QRect(
            380, 30, 113, 20))  # (140, 80, 113, 20)
        self.EdtkmEntrada.setObjectName(_fromUtf8("EdtkmEntrada"))

        self.EdtKmSaida = QLineEdit(self.groupBox)
        ...
        self.groupBox_2 = QGroupBox(FrmAluguel)
        ...
        self.btnPesqCliente.clicked.connect(lambda: self.PesquisarCliente(
            self.EdtPesqCliente.text(), self.cbPesqCliente.currentText()))

        # GRID CLIENTE
        self.gridCliente = QTableWidget(self.groupBox_2)
        ...
        self.gridCliente.setEditTriggers(
            QAbstractItemView.NoEditTriggers)
        self.gridCliente.setSelectionMode(
            QAbstractItemView.SingleSelection)

        self.groupBox_3 = QGroupBox(FrmAluguel)
        ...
        self.cbPesqVeic = QComboBox(self.groupBox_3)
        ...
        # self.cbPesqVeic.addItem(_fromUtf8(""))
        # self.cbPesqVeic.addItem(_fromUtf8(""))
        self.EdtPesqVeiculo = QLineEdit(self.groupBox_3)
        ...
        self.btnPesqVeic = QPushButton(self.groupBox_3)
        ...
        # BTN PESQ VEIC CLICK
        self.btnPesqVeic.clicked.connect(lambda: self.PesquisarVeiculo(
            self.EdtPesqVeiculo.text(), self.cbPesqVeic.currentText()))

        # GRID VEICULO
        self.gridVeiculo = QTableWidget(self.groupBox_3)
        ...
        self.gridVeiculo.setEditTriggers(
            QAbstractItemView.NoEditTriggers)
        self.gridVeiculo.setSelectionMode(
            QAbstractItemView.SingleSelection)

        # BTN SALVAR
        self.btnSalvar = QPushButton(FrmAluguel)
        self.btnSalvar.setGeometry(QtCore.QRect(430, 430, 81, 61))
        self.btnSalvar.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("Imagens/save.png")),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, FrmAluguel):
        FrmAluguel.setWindowTitle(_translate(
            "FrmAluguel", "Aluguel de Veículos", None))
        self.label.setText(_translate("FrmAluguel", "Data do Aluguel", None))
        self.label_2.setText(_translate(
            "FrmAluguel", "Prazo de Entrega", None))
        ...
        self.groupBox_2.setTitle(_translate(
            "FrmAluguel", "Selecione o Cliente", None))
        self.label_8.setText(_translate(
            "FrmAluguel", "Tipo de Pesquisa", None))
        self.cbPesqCliente.setItemText(
            0, _translate("FrmAluguel", "Código", None))
        self.cbPesqCliente.setItemText(
            1, _translate("FrmAluguel", "Nome", None))
        self.cbPesqCliente.setItemText(
            2, _translate("FrmAluguel", "CPF", None))
        self.btnPesqCliente.setText(
            _translate("FrmAluguel", "Pesquisar", None))
        ...
        self.groupBox_3.setTitle(_translate(
            "FrmAluguel", "Veículos Disponíveis", None))
        self.label_9.setText(_translate(
            "FrmAluguel", "Tipo de Pesquisa", None))
        self.cbPesqVeic.setItemText(
            0, _translate("FrmAluguel", "Código", None))
        self.cbPesqVeic.setItemText(1, _translate("FrmAluguel", "Marca", None))
        self.cbPesqVeic.setItemText(
            2, _translate("FrmAluguel", "Modelo", None))
