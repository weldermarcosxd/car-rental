...
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QColumnView, QPushButton, QLabel, QFrame, QAction
...
class Ui_FrmPrincipal(object):
    ...
    def btnListarCliente_Click(self):
        self.frmPesqCliente = QMainWindow()
    ...
    def btnListarVeiculo_Click(self):
        self.frmPesqVeiculo = QMainWindow()
    ...
    def btnListarAluguel_Click(self):
        self.frmPesqAluguel = QMainWindow()
    ...
    def setupUi(self, FrmPrincipal):
        ...
        icon.addPixmap(QtGui.QPixmap(
            _fromUtf8("Imagens/FrmIcon_Car.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        #BTN ALUGAR #############
        self.btnAlugar = QPushButton(self.centralwidget)
        ...
        icon1.addPixmap(QtGui.QPixmap(
            _fromUtf8("Imagens/btnAlugaVeiculo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        #BTN CLIENTE ###################
        self.btnCliente = QPushButton(self.centralwidget)
        ...
        icon2.addPixmap(QtGui.QPixmap(
            _fromUtf8("Imagens/btnCadCli.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        #BTN VEICULO #################
        self.btnVeiculo = QPushButton(self.centralwidget)
        ...
        icon3.addPixmap(QtGui.QPixmap(
            _fromUtf8("Imagens/FrmIcon_Car.png")), QtGui.QIcon.Selected, QtGui.QIcon.On)
        ...
        #BTN LISTAR CLIENTE #####################
        self.btnListCliente = QPushButton(self.centralwidget)
        self.btnListCliente.setGeometry(QtCore.QRect(400, 10, 131, 81))
        self.btnListCliente.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(
            _fromUtf8("Imagens/btnListCliente.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(
            "Imagens/btnListClientes.png")), QtGui.QIcon.Selected, QtGui.QIcon.On)
        ...
        #BTN LISTAR VEICULO ################
        self.btnListVeiculo = QPushButton(self.centralwidget)
        self.btnListVeiculo.setGeometry(QtCore.QRect(530, 10, 131, 81))
        self.btnListVeiculo.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(
            _fromUtf8("Imagens/btnListVeiculo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        # BTN LISTAR ALUGUEL
        self.btnListAluguel = QPushButton(self.centralwidget)
        self.btnListAluguel.setGeometry(QtCore.QRect(660, 10, 131, 81))
        self.btnListAluguel.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(
            _fromUtf8("Imagens/btnListAluguel.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, FrmPrincipal):
        FrmPrincipal.setWindowTitle(_translate(
            "FrmPrincipal", "Locadora de Veículos", None))
        self.btnAlugar.setText(_translate(
            "FrmPrincipal", "Alugar Veículo", None))
        self.btnCliente.setText(_translate(
            "FrmPrincipal", "Cadastrar Cliente", None))
        self.btnVeiculo.setText(_translate(
            "FrmPrincipal", "Cadastrar Veículo", None))
        self.btnListCliente.setText(_translate(
            "FrmPrincipal", "Listar Clientes", None))
        self.btnListVeiculo.setText(_translate(
            "FrmPrincipal", "Listar Veículos", None))
        self.btnListAluguel.setText(_translate(
            "FrmPrincipal", "Listar Alugueis", None))
        ...
        self.actionAlugar.setText(_translate(
            "FrmPrincipal", "Alugar Veículo", None))
        self.actionCliente_2.setText(
            _translate("FrmPrincipal", "Clientes", None))
        self.actionVe_culos.setText(
            _translate("FrmPrincipal", "Veículos", None))
        self.actionAlugueis.setText(
            _translate("FrmPrincipal", "Alugueis", None))
