...
class Ui_frmCliente(object):
    ...
    def btnSalvar_Click(self, estado, codigoCli):
        ...
        if estado == 'alterar':
            ...
            cliente.AtualizarCliente(
                codigoCli, nome, cpf, endereco, email, telefone)
    ...
    def setupUi(self, frmCliente, estado, codigoCli):
        ...
        self.groupBox = QGroupBox(frmCliente)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("Imagens/save.png")),
        ...
        self.btnSalvar.clicked.connect(
            lambda: self.btnSalvar_Click(estado, codigoCli))

        self.retranslateUi(frmCliente)
        QtCore.QMetaObject.connectSlotsByName(frmCliente)

    def retranslateUi(self, frmCliente):
        frmCliente.setWindowTitle(_translate(
            "frmCliente", "Cadastro de Cliente", None))
